...
function ProductList() {
    ...
    const totalItems = () => { return cart.reduce((total, item) => total + item.quantity, 0) };
    ...
    const handleOnDeleteFromCart = (plant) => {
        setAddedToCart((prevState) => ({
            ...prevState,
            [plant.name]: false,
        }));
        ...
        <div>
            ...
            {!showCart ? (
                <div className="product-grid">
                    {plantsArray.map((categoriesAndPlants, categoryIndex) => (
                        <>
                            <div style={{ margin: '15px' }}>
                                <hr />
                                <h1>{categoriesAndPlants.category}</h1>
                                <hr />
                            </div>
                            <div key={categoryIndex}>
                                <div className='product-list'>
                                    {categoriesAndPlants.plants.map((plant, plantIndex) => (
                                        <div className='product-card' key={plantIndex}>
                                            ...
                                            <button
                                                ...
                                                disabled={plant.name in addedToCart && addedToCart[plant.name] === true}>
                ...
                <CartItem onContinueShopping={handleContinueShopping} onDeletedFromCart={handleOnDeleteFromCart} />
            )
            }
        </div >
    );
